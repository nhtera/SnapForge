...
| **MVP** | Recording | • MP4 & GIF (area/window/fullscreen)<br>• Mic + system audio + webcam overlay<br>• Show clicks & keystrokes<br>• Auto Do-Not-Disturb + hide clutter<br>• Built-in trimmer + volume adjust | Countdown timer, mono/stereo toggle |
